...
def doOnlineInference_regularPneumonia (imagePath):
    ...
    outputContent += "Raw Neural Network Output : " + str(prediction[0][0]) + ". A value closer to 1 signifies illness \n\n"
    outputContent += "**************SOLUTION**************** \n\n"
    outputContent += "If you have mild symptoms and are otherwise healthy, self-isolate and contact your medical provider or a COVID-19 information line for advice.\n\n"
    outputContent += "Seek medical care if you have a fever, a cough,and difficulty breathing.Call in advance.\n\n"
    outputContent += "Raw Neural Network Output : " + str(prediction[0][0]) + ". While a value closer to 0 signifies normalness. \n\n"
    recordInferenceEvent (imagePath, outputContent)
    return outputContent


#Function inference i.e. Covid19 tests
